...
{
    /// <inheritdoc />
    public partial class AddInvoiceStructure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceItemOption", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InvoiceItemOption_InvoiceItems_InvoiceItemId",
                        column: x => x.InvoiceItemId,
                        principalTable: "InvoiceItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceItemOption_MenuOptions_MenuOptionID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceItemOption_InvoiceItemId",
                table: "InvoiceItemOption",
                column: "InvoiceItemId");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceItemOption_MenuOptionID",
                table: "InvoiceItemOption",
                column: "MenuOptionID");
